...
for (const i in textoRiscado) {
   console.log(textoRiscado[i] + ' - ' + (textoRiscado[i].match(regexRiscado) ? true : false))
}
console.log('Sublinhado\r\n--------------')
for (const i in textoSublinhado) {
   console.log(textoSublinhado[i] + ' - ' + (textoSublinhado[i].match(regexSublinhado) ? true : false))
}
console.log('\nNegrito\r\n--------------')
for (const i in textoNegrito) {
   console.log(textoNegrito[i] + ' - ' + (textoNegrito[i].match(regexNegrito) ? true : false))
}
console.log('\nItálico\r\n--------------')
for (const i in textoItalico) {
   console.log(textoItalico[i] + ' - ' + (textoItalico[i].match(regexItalico) ? true : false))
}